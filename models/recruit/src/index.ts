...
import { AccountRole, SortingOrder, type Lookup, type Ref } from '@intabiafusion/core'
...
import gmail from '@intabiafusion/model-gmail'
...
import task, { actionTemplates } from '@intabiafusion/model-task'
import tracker from '@intabiafusion/model-tracker'
import view, { createAction, showColorsViewOption, actionTemplates as viewTemplates } from '@intabiafusion/model-view'
import workbench, { createNavigateAction, type Application } from '@intabiafusion/model-workbench'
import notification, { type MessageNotificationType } from '@intabiafusion/notification'
import { type IntlString } from '@intabiafusion/platform'
import { recruitId, type Applicant, RecruitEvents } from '@intabiafusion/recruit'
import setting from '@intabiafusion/setting'
import { type KeyBinding, type ViewOptionModel, type ViewOptionsModel } from '@intabiafusion/view'
...
export { recruitId } from '@intabiafusion/recruit'
