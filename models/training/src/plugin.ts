...
import type { MessageNotificationType, NotificationGroup } from '@intabiafusion/notification'
import { trainingId } from '@intabiafusion/training'
import training from '@intabiafusion/training-resources/src/plugin'
...
export default mergeIds(trainingId, training, {
  ...
  //    > The inferred type of 'default' cannot be named without a reference to '[..]/node_modules/@intabiafusion/ui/src'.
