<script lang="ts">
  ...
  import { NavLink, createQuery, getClient, isAdminUser } from '@intabiafusion/presentation'
  import { Issue } from '@intabiafusion/tracker'
  import { ButtonKind, showPopup, Button, Icon } from '@intabiafusion/ui'
  import { DocSyncInfo, GithubIntegrationRepository, GithubProject } from '@intabiafusion/github'
