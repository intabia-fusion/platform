...
/** Fields set when a request is first enqueued. */
export type AIRequestSeed = Pick<AIRequest, 'status' | 'level' | 'modelId' | 'kind'> &
Pick<AIRequest, 'promptTokens' | 'completionTokens' | 'billedTokens'>

/** Initial AIRequest data at enqueue time: queued, zero tokens. */
