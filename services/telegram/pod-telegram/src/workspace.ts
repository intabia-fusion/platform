...
import contact, { Channel, Contact as PContact, getFirstName, getLastName } from '@intabiafusion/contact'
import core, {
  PersonId,
  Blob,
  Client,
...
import settingP from '@intabiafusion/setting'
import telegramP, { NewTelegramMessage } from '@intabiafusion/telegram'
