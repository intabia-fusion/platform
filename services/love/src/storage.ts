...
import { DatalakeConfig, DatalakeService, createDatalakeClient } from '@intabiafusion/datalake'
import { S3Config, S3Service } from '@intabiafusion/s3'
...
async function saveFileToDatalake (
  ...
  await client.createFromS3(ctx, wsIds.uuid, uuid, { filename })
