...
- Lifecycle: invite/knock UI auto-expires via TTL + heartbeat (~30s failsafe) on abrupt tab close; meeting auto-closes when only guests remain or last participant leaves; office-owner leaving cascade-disconnects all.
