...
export REGION_CONFIG_JSON='{"regions":{"":{"transactors":[{"external":"ws://localhost:3334","internal":"ws://transactor0:3334"}],"collaborators":[{"external":"ws://localhost:3079","internal":"ws://collaborator0:3079"}]}}}'
