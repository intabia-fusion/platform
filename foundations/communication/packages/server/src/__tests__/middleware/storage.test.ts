...
// import { MessageEventType, NotificationEventType, SessionData, LabelEventType, DocEventType, PeerEventType } from '@hcengineering/communication-sdk-types'
...
//     it('should handle UpdateDocClass event', async () => {
//       const event: Enriched<any> = {
...
//     })
//
//     it('should handle RemoveDoc event', async () => {
//       const event: Enriched<any> = {
