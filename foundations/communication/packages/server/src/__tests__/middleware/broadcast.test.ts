...
//     })
//
//     it('should broadcast DocEventType.UpdateDocClass to all sessions', async () => {
//       await middleware.event(session, createSessionEvent(), false)
//       middleware.subscribeCard(session, cardId, 'sub-123')
//
//       const event: Enriched<UpdateDocClassEvent> = {
//         ...basicEvent,
...
//     })
//
//     it('should broadcast DocEventType.RemoveDoc to all sessions', async () => {
//       await middleware.event(session, createSessionEvent(), false)
//       middleware.subscribeCard(session, cardId, 'sub-123')
//
//       const event: Enriched<RemoveDocEvent> = {
//         ...basicEvent,
