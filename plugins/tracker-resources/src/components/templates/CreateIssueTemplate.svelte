...
<script lang="ts">
  ...
  import { Data, Doc, Ref, generateId } from '@intabiafusion/core'
  import { Card, KeyedAttribute, SpaceSelector, createQuery, getClient } from '@intabiafusion/presentation'
  ...
  import { Component as ComponentType, IssuePriority, IssueTemplate, Milestone, Project } from '@intabiafusion/tracker'
  import { Component, EditBox, Label } from '@intabiafusion/ui'
