...
<script lang="ts">
  ...
  import tags, { type TagElement, type TagReference } from '@intabiafusion/tags'
  import { IssueTemplate, IssueTemplateChild, Project } from '@intabiafusion/tracker'
  import { Button, EditBox, IconMoreH, Label, getCurrentResolvedLocation, navigate } from '@intabiafusion/ui'
