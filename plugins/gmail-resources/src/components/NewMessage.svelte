...
<script lang="ts">
  ...
  import core, { Data, Markup, generateId } from '@intabiafusion/core'
  import { NewMessage, SharedMessage, GmailEvents } from '@intabiafusion/gmail'
  ...
  import { Button, EditBox, IconArrowLeft, IconAttachment, Label, Scroller } from '@intabiafusion/ui'
