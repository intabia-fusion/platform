<script lang="ts">
  ...
  import { type Class, type Doc, type Ref, type Space, SortingOrder } from '@intabiafusion/core'
  import { MessageBox, createQuery, getClient } from '@intabiafusion/presentation'
  import { makeRank } from '@intabiafusion/rank'
  import time, { ToDo, ToDoPriority } from '@intabiafusion/time'
  import { CheckBox, getEventPositionElement, showPopup, Component } from '@intabiafusion/ui'
