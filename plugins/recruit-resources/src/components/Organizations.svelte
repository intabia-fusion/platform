...
<script lang="ts">
  ...
  import core, { Doc, DocumentQuery, Ref, WithLookup } from '@intabiafusion/core'
  import { createQuery } from '@intabiafusion/presentation'
  import { Applicant, Vacancy } from '@intabiafusion/recruit'
  import { Button, Component, IconAdd, Breadcrumb, Loading, SearchInput, showPopup, Header } from '@intabiafusion/ui'
  ...
  import { ExportButton } from '@intabiafusion/export-resources'
