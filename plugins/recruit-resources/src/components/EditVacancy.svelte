...
<script lang="ts">
  ...
  import { Data, Doc, type MarkupBlobRef, Mixin, Ref } from '@intabiafusion/core'
  ...
  import { Button, Component, EditBox, IconMixin, IconMoreH, Label } from '@intabiafusion/ui'
  import view from '@intabiafusion/view'
  import { DocAttributeBar, DocNavLink, getDocMixins, showMenu } from '@intabiafusion/view-resources'
