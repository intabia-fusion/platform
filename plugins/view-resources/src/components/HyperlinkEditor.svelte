...
<script lang="ts">
  ...
  import type { AnySvelteComponent, ButtonKind, ButtonSize, IconProps } from '@intabiafusion/ui'
  import { Button, Label, eventToHTMLElement, parseURL, showPopup } from '@intabiafusion/ui'
