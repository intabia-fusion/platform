<script lang="ts">
  ...
  import { IModeSelector, ModeSelector, SearchInput, Header, Breadcrumb, HeaderAdaptive } from '@intabiafusion/ui'
  import type { Asset } from '@intabiafusion/platform'
  import { ComponentExtensions, getClient } from '@intabiafusion/presentation'
  import view, { Viewlet, type ViewletViewAction } from '@intabiafusion/view'
