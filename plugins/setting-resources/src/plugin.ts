...
export default mergeIds(settingId, setting, {
  ...
  string: {
    ...
    WebhookRules: '' as IntlString,
    WebhookRulesCount: '' as IntlString,
    NoWebhookRules: '' as IntlString,
    WebhookRuleMoveUp: '' as IntlString,
    WebhookRuleMoveDown: '' as IntlString,
    EditWebhookRule: '' as IntlString,
    WebhookRuleDelete: '' as IntlString,
    WebhookRuleDeleteConfirm: '' as IntlString,
    CreateWebhookRule: '' as IntlString,
    WebhookRuleFromTemplate: '' as IntlString,
    WebhookRuleFromTemplateTitle: '' as IntlString,
    WebhookRuleFromTemplateNoOps: '' as IntlString,
    WebhookRuleFromTemplateAuthHint: '' as IntlString,
    WebhookRuleSampleBody: '' as IntlString,
    WebhookRuleSampleBodyPlaceholder: '' as IntlString,
    WebhookRuleSampleBodyInvalid: '' as IntlString,
    WebhookRuleSource: '' as IntlString,
    WebhookRuleTemplateDocsLink: '' as IntlString,
    WebhookRulePickPath: '' as IntlString,
    WebhookRuleInsertValue: '' as IntlString,
    WebhookRuleNoSampleHint: '' as IntlString,
    WebhookRuleConditions: '' as IntlString,
    WebhookRulePathPlaceholder: '' as IntlString,
    WebhookRuleValuePlaceholder: '' as IntlString,
    WebhookRuleValuesPlaceholder: '' as IntlString,
    WebhookRuleOpEq: '' as IntlString,
    WebhookRuleOpNeq: '' as IntlString,
    WebhookRuleOpExists: '' as IntlString,
    WebhookRuleOpRegex: '' as IntlString,
    WebhookRuleOpIn: '' as IntlString,
    WebhookRuleForEach: '' as IntlString,
    WebhookRuleForEachPlaceholder: '' as IntlString,
    WebhookRuleForEachNone: '' as IntlString,
    WebhookRuleWhere: '' as IntlString,
    WebhookRuleFields: '' as IntlString,
    WebhookRuleFieldTemplatePlaceholder: '' as IntlString,
    WebhookRulePreview: '' as IntlString,
    WebhookRulePreviewNoSample: '' as IntlString,
    WebhookRulePreviewError: '' as IntlString,
    WebhookRulePreviewMatched: '' as IntlString,
    WebhookRulePreviewNotMatched: '' as IntlString,
    WebhookRulePreviewItems: '' as IntlString,
    WebhookRulePreviewTooMany: '' as IntlString,
    WebhookRuleConditionPassed: '' as IntlString,
    WebhookRuleConditionFailed: '' as IntlString
  }
})
