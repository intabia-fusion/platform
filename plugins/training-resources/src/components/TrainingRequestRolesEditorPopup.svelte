...
<script lang="ts">
  import core, { type DocumentQuery, type FindOptions, type Ref, type Role, SortingOrder } from '@intabiafusion/core'
  import presentation, { ObjectPopup } from '@intabiafusion/presentation'
