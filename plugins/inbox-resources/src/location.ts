...
import { navigate, type Location, getCurrentResolvedLocation, locationStorageKeyId } from '@hcengineering/ui'
...
export function navigateToDoc (navItem: NavigationItem, doc: Doc, notification?: Notification): void {
  ...
  if (notification?.message != null) {
    loc.query = {
      ...loc.query,
      message: encodeURIComponent(`${notification.messageId}:${notification.message.created.toISOString()}`)
    }
  } else {
