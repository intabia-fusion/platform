...
<script lang="ts">
  ...
  import { Button, DebouncedCaller, IconMoreH, ThrottledCaller } from '@intabiafusion/ui'
  import view from '@intabiafusion/view'
  import { DocNavLink, ParentsNavigator, showMenu } from '@intabiafusion/view-resources'
