...
<script lang="ts">
  ...
  import { ContactPresenter } from '@intabiafusion/contact-resources'
  ...
  import { AssigneePresenter, StateRefPresenter } from '@intabiafusion/task-resources'
  import { ActionIcon, Component, DueDatePresenter, IconMoreH } from '@intabiafusion/ui'
  import { BuildModelKey } from '@intabiafusion/view'
  import { enabledConfig, openDoc, showMenu, statusStore } from '@intabiafusion/view-resources'
