...
<script lang="ts">
  ...
  import { ButtonIcon, IconMinimize, IconSend, ModernButton, ModernEditbox } from '@intabiafusion/ui'
  import { createEventDispatcher } from 'svelte'

  import { Analytics } from '@intabiafusion/analytics'
  import { AttachmentStyledBox } from '@intabiafusion/attachment-resources'
  import { Card, MasterTag, type CardSpace } from '@intabiafusion/card'
  import chat from '@intabiafusion/chat'
  import { defaultMessageInputActions } from '@intabiafusion/communication-resources'
  import { AttachmentID, BlobParams } from '@intabiafusion/communication-types'
  import core, { Data, generateId, getCurrentAccount, Markup, Ref } from '@intabiafusion/core'
  import { getResource } from '@intabiafusion/platform'
  import { EmptyMarkup, isEmptyMarkup, markupToJSON, markupToText } from '@intabiafusion/text'
  import textEditor, { type RefAction } from '@intabiafusion/text-editor'
  import { AttachIcon } from '@intabiafusion/text-editor-resources'
