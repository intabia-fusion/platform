...
export default plugin(workflowId, {
  ...
  string: {
    ...
    TargetProjectType: '' as IntlString,
    TargetTaskType: '' as IntlString,
    StatusMapping: '' as IntlString,
    SourceStatus: '' as IntlString,
    TargetStatus: '' as IntlString,
    AttributeResolution: '' as IntlString,
    MissingAttributesWarning: '' as IntlString,
    CreateMissingField: '' as IntlString,
    MapToExistingField: '' as IntlString,
    SkipRule: '' as IntlString,
    FieldCreated: '' as IntlString,
    SelectTargetField: '' as IntlString,
    NoCompatibleFields: '' as IntlString,
    RuleSkipped: '' as IntlString,
    AllAttributesMatch: '' as IntlString,
    AllStatusesMatch: '' as IntlString,
    CopyScreens: '' as IntlString,
    CopyScreensDescription: '' as IntlString,
    SelectWorkflowFile: '' as IntlString,
    InvalidWorkflowFile: '' as IntlString,
    ImportSuccess: '' as IntlString,
    WorkflowsToImport: '' as IntlString,
    ScreensToImport: '' as IntlString,
    StatusCheck: '' as IntlString,
    AllStatusesFound: '' as IntlString,
    MissingStatusesWarning: '' as IntlString,
    CopyFromExisting: '' as IntlString,
    SourceWorkflow: '' as IntlString,
    SourceProjectType: '' as IntlString,
    ...
    StepTransitions: '' as IntlString,
    ScreensFoundInWorkflow: '' as IntlString,
    ChangeFile: '' as IntlString,
    SkipStatus: '' as IntlString,
    AffectedTransitionsWarning: '' as IntlString,
    DeleteTransition: '' as IntlString,
    RedirectTransition: '' as IntlString,
    SelectTargetStatus: '' as IntlString,
    DuplicateStatusMappingWarning: '' as IntlString,
    UnmappedStatusesWarning: '' as IntlString,
    CreateMissingStatuses: '' as IntlString,
    CreateMissingStatusesDescription: '' as IntlString,
    WillBeCreated: '' as IntlString,
    MissingStatusesWillBeCreated: '' as IntlString,
    CreateMissingAttributes: '' as IntlString,
    UsedInTransitions: '' as IntlString,
    Tab: '' as IntlString,
    Show: '' as IntlString,
    Hide: '' as IntlString,
    ...
    InvalidFormat: '' as IntlString,
    ClipboardEmpty: '' as IntlString,
    ClipboardReadError: '' as IntlString,
    ImportFromFile: '' as IntlString,
    ImportFromClipboard: '' as IntlString,
    CopyToClipboard: '' as IntlString,
    ExportToFile: '' as IntlString,
    PasteJsonPlaceholder: '' as IntlString,
    OrUploadFile: '' as IntlString,
    InvalidFileType: '' as IntlString,
    ActionCopy: '' as IntlString,
    ActionCreate: '' as IntlString,
    ActionImport: '' as IntlString,
    ActionReplace: '' as IntlString,
    ActionSkip: '' as IntlString,
    ReplaceExistingScreen: '' as IntlString,
    CreateNewScreen: '' as IntlString,
    DoNotImportScreen: '' as IntlString,
    SelectTargetScreen: '' as IntlString,
    ScreenAction: '' as IntlString,
    ScreenSkipped: '' as IntlString,
    ScreenReplaced: '' as IntlString,
    ScreenCopied: '' as IntlString,
    UseExistingScreen: '' as IntlString,
    CreateCopy: '' as IntlString,
    ScreenStructureMatches: '' as IntlString<{ name: string }>,
    ScreenMatchesExisting: '' as IntlString,
    ScreenSkippedTransitionsWarning: '' as IntlString<{ transitions: string }>,
    AttributesToCreate: '' as IntlString,
    AttributesToCreateDescription: '' as IntlString<{ name: string }>,
    AttributesToCreateDescriptionFallback: '' as IntlString,
    AttributeSkippedWarning: '' as IntlString,
    AttributesSkippedGlobalWarning: '' as IntlString,
    UsedInScreens: '' as IntlString,
    UsedInRules: '' as IntlString,
    AffectedScreensAndRules: '' as IntlString,
