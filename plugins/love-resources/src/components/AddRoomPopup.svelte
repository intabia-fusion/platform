<script lang="ts">
  import core, { Class, Data, generateId, type Doc, Ref } from '@intabiafusion/core'
  import { Floor, getFreePosition, Office, Room, RoomAccess, RoomType } from '@intabiafusion/love'
  import { translate } from '@intabiafusion/platform'
  import { getClient } from '@intabiafusion/presentation'
  import setting, { type OfficeSettings } from '@intabiafusion/setting'
  import { Button, DropdownIntlItem } from '@intabiafusion/ui'
