...
<script lang="ts">
  ...
  import { Doc, Mixin, WithLookup } from '@intabiafusion/core'
  import testManagement, { TestResult } from '@intabiafusion/test-management'
  import { DocAttributeBar, getDocMixins } from '@intabiafusion/view-resources'
