...
<script lang="ts">
  ...
  import core, { AttachedData, Doc, Ref, SortingOrder, generateId, getCurrentAccount } from '@intabiafusion/core'
  import { SpaceSelector, createQuery, getClient } from '@intabiafusion/presentation'
  import tagsPlugin, { TagReference } from '@intabiafusion/tags'
  import task, { makeRank } from '@intabiafusion/task'
  import { StyledTextBox } from '@intabiafusion/text-editor-resources'
  import { TimeEvents, ToDo, ToDoPriority, WorkSlot } from '@intabiafusion/time'
  import { Button, Component, EditBox, IconClose, Label, Scroller } from '@intabiafusion/ui'
