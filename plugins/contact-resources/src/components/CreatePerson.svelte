...
-->
<script lang="ts">
  import { AvatarType, Channel, combineName, ContactEvents, findPerson, Person } from '@intabiafusion/contact'
  import { AttachedData, Data, generateId } from '@intabiafusion/core'
