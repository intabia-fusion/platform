...
<script lang="ts">
  ...
  import { WorkflowPostFunction, WorkflowPostFunctionConfig } from '@hcengineering/workflow'

  export let config: WorkflowPostFunctionConfig
  export let taskType: TaskType
  export let postFunction: WorkflowPostFunction | undefined = undefined

  let presenterCtor: AnySvelteComponent | undefined = undefined

  $: void loadPresenter(postFunction?.presenter)
...
{#if presenterCtor}
  <svelte:component this={presenterCtor} {config} {taskType} {postFunction} />
{/if}
