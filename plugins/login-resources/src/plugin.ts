...
export default mergeIds(loginId, login, {
  ...
  string: {
    ...
    AgreedPersonalData: '' as IntlString,
    AgreedRules: '' as IntlString,
    ...
    NoFreeSeats: '' as IntlString,
    NoFreeSeatsDescription: '' as IntlString,
    NoFreeSeatsForInvite: '' as IntlString,
