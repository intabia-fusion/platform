...
-->
<script lang="ts">
  import { checkForbiddenPermission, type Class, type Doc, type Ref } from '@intabiafusion/core'
  import type { AnySvelteComponent, ButtonKind, ButtonSize } from '@intabiafusion/ui'
