...
* 🐛 BUG FIXES: · Fix build tooling cache miss ([#469](https://github.com/hcengineering/platform/issues/469)) · Skip workflow import attributes with unknown types and tolerate in UI ([#467](https://github.com/hcengineering/platform/issues/467)) · Fix activity service to listen for backup/restore ([#466](https://github.com/hcengineering/platform/issues/466)) · Stability fixes ([#444](https://github.com/hcengineering/platform/issues/444)) · FUSIO-637 - Исправлено уведомление при запросе в закрытую комнату ([#460](https://github.com/hcengineering/platform/issues/460)) · Fix indexes apply · FUSIO-1397: Fix reverse lookup ([#459](https://github.com/hcengineering/platform/issues/459)) · FUSIO-38: Fix how todo + issue work ([#456](https://github.com/hcengineering/platform/issues/456)) · FUSIO-289 Ai sumary fixes ([#448](https://github.com/hcengineering/platform/issues/448)) · FUSIO-1119 - Доработки созвонов ([#430](https://github.com/hcengineering/platform/issues/430)) · FUSIO-1370: Fix hang on documents ([#451](https://github.com/hcengineering/platform/issues/451)) · Fix front deps
* 🧩 OTHER: · Disable webpack compression for tests phases ([#463](https://github.com/hcengineering/platform/issues/463)) · Specifications ([#468](https://github.com/hcengineering/platform/issues/468)) · Trim the startup query wave: lazy loaders, no dead translation query ([#465](https://github.com/hcengineering/platform/issues/465)) · Lazy-load office details ([#464](https://github.com/hcengineering/platform/issues/464)) · Parallelize login handshake queries ([#462](https://github.com/hcengineering/platform/issues/462)) · Use last v build for local tags ([#457](https://github.com/hcengineering/platform/issues/457)) · Try pool for smtp ([#455](https://github.com/hcengineering/platform/issues/455)) · clean up plugin deps ([#452](https://github.com/hcengineering/platform/issues/452)) · Update go deps for stream service ([#450](https://github.com/hcengineering/platform/issues/450))
